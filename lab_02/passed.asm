...
data_seg segment para 'DATA'
    ...
    ; выводимые сообщения
    msg_in_rm   db 27, '[32;20mNow in real mode. Press any key to enter protect mode', 27, '[0m$'
    msg_out_pm  db 27, '[32;20mNow in real mode.', 27, '[0m$'
...
start:
    ...
    push eax				;ожидаем ввода символа
    mov ah, 10h
    int 16h
    pop eax
